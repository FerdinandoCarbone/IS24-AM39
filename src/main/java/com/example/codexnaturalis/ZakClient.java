...
public class ZakClient {
    ...
    static boolean validStrings(String s) {
        boolean flag = false;
        if (s.equals("Seleziona se vuoi piazzare la carta di fronte o retro: 1) -> Fronte | 0) -> Retro") ||
            s.equals("2) Analizza il tavolo") ||
            s.equals("Seleziona il numero della carta che vuoi piazzare: ") ||
            s.equals("Seleziona la riga:") ||
            s.equals("Seleziona la colonna:") ||
            ...
            s.equals("Inserisci il nome utente che userai per la partita: ") ||
